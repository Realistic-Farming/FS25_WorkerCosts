...
-- :571-583 is modelled through its time arithmetic (the function is :567-588): it keeps the day and the monotonic
...
--- :571-583 through its arithmetic (gsSetDayTime): the day and the monotonic day held,
